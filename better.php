...
$botToken = "314881338:AAGJEc5X4wT9eeb3Y6rJ4CrtNhHUjEgV-qw";
...
//this receives input from the user and saves it as a variable
	...
	switch($newmessage) {
		...
		case "Hello":
        $botMessage="Hi which book do want? ";
        $botMessage="1.Tresure island 2.Snow white 3.Zootopia 4.Cindarella"
		file_get_contents($website."/sendmessage?chat_id=".$chatId."&text=".$botMessage);
        break;
		
		case "1":
        $botMessage="Author;Smith brown,Year of publication";
		file_get_contents($website."/sendmessage?chat_id=".$chatId."&text=".$botMessage);
        break;
        
		case "2":
        $botMessage="Author:Willian Marshal,Year of publication?";
		file_get_contents($website."/sendmessage?chat_id=".$chatId."&text=".$botMessage);
        break;
                
		case "3":
        $botMessage="Author:Ji-Hyun Chan,Year of publication";
		file_get_contents($website."/sendmessage?chat_id=".$chatId."&text=".$botMessage);
        break;

		case "Author:Alen Son,Year of publication":
